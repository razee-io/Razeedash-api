...
RAZEE_QUERY='query($clusterId: String!) { subscriptionsByClusterId(clusterId: $clusterId) { subscriptionName, subscriptionUuid, url, remote { remoteType, parameters { key, value } }, kubeOwnerName } }'
