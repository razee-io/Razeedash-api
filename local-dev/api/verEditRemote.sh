...
echo "********************"
echo "********************"
echo "NOT YET IMPLEMENTED! Not expected to work"
echo "********************"
echo "********************"


RAZEE_QUERY='mutation($orgId: String!, $channelUuid: String!, $name: String!, $type: String!, $description: String, $remote: VersionRemoteInput) { editChannelVersion( orgId: $orgId, channelUuid: $channelUuid, name: $name, type: $type, description: $description, remote: $remote ) { versionUuid success } }'
...
echo "" && echo "EDIT version by name (remote configuration)"
