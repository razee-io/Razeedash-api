...
RAZEE_CLUSTER_ID=${3:-${RAZEE_CLUSTER_ID:-pClusterId}}
...
RAZEE_VARIABLES='{"name":"'"${RAZEE_SSUB_NAME}"'","orgId":"'"${RAZEE_ORG_ID}"'","clusterId":"'"${RAZEE_CLUSTER_ID}"'","channelUuid":"'"${RAZEE_CONFIG_UUID}"'","versionUuid":"'"${RAZEE_VER_UUID}"'"}'
