...
RAZEE_QUERY='query($orgId: String! $uuid: String!) { channel( orgId: $orgId uuid: $uuid) { uuid orgId name data_location contentType remote { type parameters } created versions { uuid name description } } }'
