...
RAZEE_QUERY='query($orgId: String! $uuid: String!) { channel( orgId: $orgId uuid: $uuid) { uuid orgId name data_location contentType remote { remoteType parameters {key value} } created versions { uuid name description } } }'
