...
RAZEE_QUERY='query($orgId: String!, $channelUuid: String!, $versionUuid: String!) { channelVersion(orgId:$orgId, channelUuid:$channelUuid, versionUuid:$versionUuid) { uuid, name, description, type, content, remote { parameters { key, value } }, created } }'
