...
RAZEE_GROUP_UUID=${4:-${RAZEE_GROUP_UUID:-pGroupUuid}}
...
RAZEE_VARIABLES='{"name":"'"${RAZEE_SUB_NAME}"'","orgId":"'"${RAZEE_ORG_ID}"'","groups":["'"${RAZEE_GROUP_UUID}"'"],"channelUuid":"'"${RAZEE_CONFIG_UUID}"'","versionUuid":"'"${RAZEE_VER_UUID}"'"}'
